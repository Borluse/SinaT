...
//	NSLog(@"%@", [sinaAPI retrieveUsersSuggestionsWith_reason:[NSNumber numberWithInt:1]]);
	...
	//[sinaAPI retrieveDirect_messagesSentWithSinceID:nil MaxID:nil Count:nil Page:nil];
	//[sinaAPI retrieveDirect_messagesNewWithUserID:@"1611598955" text:@"这臭的头头"];
	//	[sinaAPI retrieveDirect_messagesDestroyWithID:@"877133527"];
	//[sinaAPI retrieveDirect_messagesUserlistWithCount:nil cursor:nil];
	//	[sinaAPI retrieveFriendsshipsShowWithUserAID:nil userAName:nil userBID:nil userBName:@"碰碰狸"];
	//	[sinaAPI retrieveFriendsshipsDestroyWithUserID:nil screen_name:@"碰碰狸"];
	//		[sinaAPI retrieveFriendsshipsCreateWithUserID:nil screen_name:@"碰碰狸"];
	//	[sinaAPI retrieveTrendsWithUserID:@"1390984450"];
	//	[sinaAPI retrieveTrendsStatusesWithTrend_name:@"凉宫春日的消失"];
	//	[sinaAPI retrieveTrendsFollowWithTrend_name:@"凉宫春日的消失"];
	//[sinaAPI retrieveTrendsDestroyWithTrend_id:@"1832060"];
	//	[sinaAPI retrieveTrendsHourly];
	//	[sinaAPI retrieveTrendsWeekly];
	//	[sinaAPI retrieveTrendsDaily];
	//	[sinaAPI retrieveFollowersIdsWithUserID:nil screen_name:@"碰碰狸" count:nil cursor:nil];
	//	[sinaAPI retrieveFriendsIdsWithUserID:nil screen_name:@"碰碰狸" count:nil cursor:nil];
	//	[sinaAPI retrieveAccountGet_privacy];
	//	[sinaAPI retrieveBlocksCreateWithUser_id:nil screen_name:@"碰碰狸"];
	//	[sinaAPI retrieveBlocksDestroyWithUser_id:nil screen_name:@"碰碰狸"];
	//	[sinaAPI retrieveBlocksExistWithUser_id:nil screen_name:@"碰碰狸"];
	//	[sinaAPI retrieveBlocksBlockingWithPage:nil count:nil];
	//	[sinaAPI retrieveTagsWithUser_id:@"1390984450" count:nil page:nil];
	//	[sinaAPI retrieveTagsCreateWithTags:@"测试TAGS,长门有希,凉宫春日"];
	//	[sinaAPI retrieveTagsDestroyWithTag_id:@"221101070002554878"];
	//	[sinaAPI retrieveTagsDestroy_BatchWithIds:[NSArray arrayWithObjects:@"45643",@"142705",nil]];
	//    [sinaAPI retrieveAccountUpdate_profile_imageWithImage:@"/pic/pic.jpg"];
	//    [sinaAPI retrieveAccountUpload_profileWithName:nil gender:nil province:nil city:nil description:@"学习，生活"];
	//    [sinaAPI retrieveFavoritesWithPage:nil];
	//    [sinaAPI retrieveFavoritesDestroyWithID:@"5280005525"];
	//  [sinaAPI retrieveFavoritesWithPage:nil];
	//    [sinaAPI retrieveFavoritesCreate:@"5280005525"];d
